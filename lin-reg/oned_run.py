...
def init_pairs(performance_df,init_value=15,n_training_samples=12):
...
def opro(performance_df,prompt_template,n_scores=32,n_prompts=12,n_training_samples=12,max_iterations=15):
...
performance_df = init_pairs(performance_df,init_value=15,n_training_samples=12)

performance_df = opro(performance_df,oned_meta_prompt,n_scores=12,n_prompts=3,n_training_samples=12,max_iterations=20)
